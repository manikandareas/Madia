<template>
  <svg
    ...
    viewBox="0 0 36 36"
  >
    <ellipse cx="8.828" cy="18" fill="#F5F8FA" rx="7.953" ry="13.281"></ellipse>
    <path
      fill="#E1E8ED"
    ...
    ></path>
    <circle cx="6.594" cy="18" r="4.96" fill="#8899A6"></circle>
    <circle cx="6.594" cy="18" r="3.565" fill="#292F33"></circle>
    <circle cx="7.911" cy="15.443" r="1.426" fill="#F5F8FA"></circle>
    <ellipse
      cx="27.234"
      cy="18"
      fill="#F5F8FA"
    ...
    ></path>
    <circle cx="25" cy="18" r="4.96" fill="#8899A6"></circle>
    <circle cx="25" cy="18" r="3.565" fill="#292F33"></circle>
    <circle cx="26.317" cy="15.443" r="1.426" fill="#F5F8FA"></circle>
  </svg>
</template>
